...
def sync_slots_from_config(
    ...
    for slot in slots_from_json:
        ...
        zone_id = slot.zone_id or default_zone_id or None
        zone_name = slot.zone_name or default_zone_name or zone_id or slot.label or slot.id
